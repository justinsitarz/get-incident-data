# Usually the incident number, priority, desc, # of alerts, create date time, and similar fields for executive presentation(s). 
# How can I do export info quickly and efficiently? Most tools just have a n export data button from any search field.
...
api_key = '<your api key>' # ensure that this key has permission access configurations
user_data_csv = './user-list.csv' # will create csv in directory this script is run from
